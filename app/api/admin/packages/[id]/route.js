/**
 * BFF: GET/PATCH/DELETE → /api/v1/admin/packages/:id
 * PATCH: strip `slug` if present (server-generated from title).
 */
...
export async function GET(_request, { params }) {
  ...
  const url = `${getTelApiBase()}/api/v1/admin/packages/${encodeURIComponent(id)}`;
